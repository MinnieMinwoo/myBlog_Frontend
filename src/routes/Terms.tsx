        ...
        <div className="row">
          <div className="col col-10 offset-1 col-lg-8 offset-lg-2 col-xxl-6 offset-xxl-3 mb-4">
            ...
            <p className="mt-2 mb-4">
              This Terms of Service Agreement ("Agreement") is entered into between myblog-backend.firebaseapp.com ("our
              website") and the user ("User" or "You") of the myBlog ("Service"). By accessing or using the Service, You
              agree to be bound by the terms and conditions outlined in this Agreement.
            </p>
